...
class ImageSearchService:
    ...
    async def search(
        ...
        cached_result = None
        if use_cache:
            cached_result = await cache_service.get_search_results(query, page, search_type="image")
        ...
        try:
            ...
            # Cache results
            await cache_service.set_search_results(query, page, normalized, search_type="image")
